...
//Fake Reply Group
	const reply = (teks) => {
            Zaki.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/Zaki.jpg`),"sourceUrl": "https://chat.whatsapp.com/IsFlsGomn1rBOl2MBB2hBG"}}}, { quoted: m})
        }
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://chat.whatsapp.com/IsFlsGomn1rBOl2MBB2hBG'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Owner',
...
//━━━━━━━━━━━━━━━[ MENU LOC ]━━━━━━━━━━━━━━━\\
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: anu.trim(), locationMessage: { jpegThumbnail: fs.readFileSync('./media/menu.jpg') }, hydratedFooterText: `Terima Kasih Telah Menggunakan Script Ini, Mohon Jangan Di Perjual Belikan!`, hydratedButtons: [{ urlButton: { displayText: 'YouTube', url: 'https://m.youtube.com/channel/UCHdipvk52k43KsPRenGpD0w'} }, { urlButton: { displayText: 'Group', url: 'https://chat.whatsapp.com/IsFlsGomn1rBOl2MBB2hBG'} }, { quickReplyButton: { displayText: 'Owner', id: 'owner', } }, { quickReplyButton: { displayText: 'Donate', id: 'donate', } }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  Zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
